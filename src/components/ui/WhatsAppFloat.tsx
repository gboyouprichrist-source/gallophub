...
export function WhatsAppFloat({ message = 'Bonjour, je souhaite en savoir plus sur vos chevaux.' }: WhatsAppFloatProps) {
    ...
    <a
      ...
      onClick={() => {
        if (typeof window !== 'undefined' && 'gtag' in window) {
          (window as unknown as Record<string, (...args: unknown[]) => void>).gtag('event', 'conversion', { send_to: 'AW-CONVERSION_ID/whatsapp_click' });
        }
      }}
    >
      {/* Pulse ring */}
